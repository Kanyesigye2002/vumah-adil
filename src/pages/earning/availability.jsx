...
export default function Availability() {
  ...
  return (
    <>
                ...
                >
                  ...
                  */}
                  <div class='banner-search-field'>
                    <input autoComplete={'off'} type='text' name='daterange' value={`${startDate} - ${endDate}`}
                           className='text-center-align' />
                    <div id='my-week-selector' style={{ position: 'absolute', top: '100%', left: 0 }} />
                  </div>
                </DateRangePicker>
              </div>
            </div>
      ...
      <Modal isOpen={showChangeAvailabilityPopup} toggle={toggleShowChangeAvailabilityPopup}
             className='loginPopupMain add-listing-main'>
        <ModalHeader toggle={toggleShowChangeAvailabilityPopup} close={modalCloseBtn} />
        <ModalBody>
          <div className='login-inner'>
            ...
            <div className='contact-form-field radio-field available-all-day-radio mt-4'>
              <input type='radio' id='t1' checked={availability === 'availAbleAllDay'}
                     className='styled-checkbox availability-checkbox' value='availAbleAllDay'
            ...
            <div className='contact-form-field radio-field custom-hours-radio mt-2'>
              <input type='radio' id='t2' checked={availability === 'customHours'}
                     className='styled-checkbox availability-checkbox' value='customHours'
                     onChange={onChangeAvailability} />
            ...
            <div className='contact-form-field radio-field unavailable-radio mt-2'>
              <input type='radio' id='t3' checked={availability === 'unavilable'}
                     className='styled-checkbox availability-checkbox' value='unavilable'
                     onChange={onChangeAvailability} />
