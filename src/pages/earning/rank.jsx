...
import LineGraphLevelOne from '../../assets/img/line-graph-level-1.png';
import DarkLineGraphLevelOne from '../../assets/img/line-graph-dark-level-1.png';
import LineGraphLevelTwo from '../../assets/img/line-graph-level-2.png';
import DarkLineGraphLevelTwo from '../../assets/img/line-graph-dark-level-2.png';
import LineGraphLevelThree from '../../assets/img/line-graph-level-3.png';
import DarkLineGraphLevelThree from '../../assets/img/line-graph-dark-level-3.png';
import LineGraphLevelFour from '../../assets/img/line-graph-level-4.png';
import DarkLineGraphLevelFour from '../../assets/img/line-graph-dark-level-4.png';
    ...
    <>
      <div className="earning-main host-ranking">
            ...
            <div className="overview-header">
              ...
              <div className="select-outere">
                <div className="banner-search-dropdowne dropdown">
                  ...
                  <ul className="dropdown-menu vumah-dropdown-menu">

                    <li>
                      <a className="dropdown-item vechiles" href="#">
                        April 2021
                      </a>
                    </li>
                    <li>
        ...
        <Nav tabs className="border-0 mb-4">
          ...
          <NavItem>
            <NavLink
              className={classnames({ active: activeTab === '5' }) + ' pointer'}
        ...
        <TabContent className="w-100 padding-left-zero" activeTab={activeTab}>
          <TabPane tabId="1">
            ...
            <img src={DarkLineGraphLevelOne} alt="graph" className="mb-4 w-100 dark-graph" />
            <div className="ranking-percentage mb-4 d-flex flex-wrap align-items-center">
              <div className="ranking-percent-grid text-center level-1">
                <h2>
            ...
            <div className="ranking-paragraph">
              ...
              <p className="logo-left-side-content">
                ...
                There are 5 levels,
                each dependent on the amount of booking days the host manages to reach
                within the
              ...
              <p>
                ...
                within that month
                you will drop down a level, but you are able to move up multiple levels at
                any time within
                the month.
          ...
          <TabPane tabId="2">
            ...
            <img src={DarkLineGraphLevelTwo} alt="graph" className="mb-4 w-100 dark-graph" />
            <div className="ranking-percentage mb-4 d-flex flex-wrap align-items-center">
              <div className="ranking-percent-grid text-center">
                <h2>
                  0%<span className="ranking-off">off</span>
          ...
          <TabPane tabId="3">
            ...
            <img src={DarkLineGraphLevelThree} alt="graph" className="mb-4 w-100 dark-graph" />
            <div className="ranking-percentage mb-4 d-flex flex-wrap align-items-center">
              <div className="ranking-percent-grid text-center">
                <h2>
                  0%<span className="ranking-off">off</span>
          ...
          <TabPane tabId="4">
            ...
            <img src={LineGraphLevelFour} alt="graph" className="mb-4 w-100 light-graph" />
            <img src={DarkLineGraphLevelFour} alt="graph" className="mb-4 w-100 dark-graph" />
            <div className="ranking-percentage mb-4 d-flex flex-wrap align-items-center">
              <div className="ranking-percent-grid text-center">
                <h2>
                  0%<span className="ranking-off">off</span>
          ...
          <TabPane tabId="5">
            ...
            <img src={LineGraphLevelFive} alt="graph" className="mb-4 w-100 light-graph" />
            <img src={DarkLineGraphLevelFive} alt="graph" className="mb-4 w-100 dark-graph" />
            <div className="ranking-percentage mb-4 d-flex flex-wrap align-items-center">
              <div className="ranking-percent-grid text-center">
                <h2>
                  0%<span className="ranking-off">off</span>
