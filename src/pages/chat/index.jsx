...
export default function Chat() {
  ...
  return (
    <>
      ...
      <div className="padd-top-60" style={ (location.pathname === '/chat') ? { transform: 'scale(0.9)', transformOrigin: '0 0', width: '110%', marginBottom: '-50px' } : {}}>
              ...
              <form>
                <div style={{ display: 'flex', alignItems: 'flex-start', marginBottom: '10px', padding: '0 0 10px 0' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', marginLeft: '20px' }}>
                    ...
                    <button className="btn btn-light my-button" style={{textDecoration: 'underline', marginLeft: 'auto', marginRight: 0, paddingRight: 0, fontSize:'14px'}}>
                      Report guest
                    </button>
                  </div>
                </div>
