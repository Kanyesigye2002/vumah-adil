    ...
    <div className="container-landing">
      ...
      <section className="car pt-5">
        <div className="text-container-landing vehicle-text-container">
          <div className="text-container-landing-inner">
            <h1>Cars</h1>
            <p className="lead">Whether you need a luxurious car for a trip through the city or a sturdy one for
      ...
      <section className="motorbike">
        <div className="text-container-landing vehicle-text-container">
          <div className="text-container-landing-inner">
            <h1>Motorcycles</h1>
            <p className="lead">If you’re a bike lover and want to roam around the city on a bike, you can easily
              rent a
      ...
      <section className="bike">
        <div className="text-container-landing vehicle-text-container">
          <div className="text-container-landing-inner">
            <h1>Even Bicycles</h1>
            <p className="lead">Bicycles are convenient and let you tackle the busy routes easily. Ride through fields or brave challenging mountain terrains to
              give
