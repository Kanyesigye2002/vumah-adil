...
const services = [
  { title: 'Cars', icon: <ElectricCar color='primary' sx={{ mb: 2, width: '60px', height: '60px'}}/>, desc: 'A wide range of cars to choose from for your exciting adventures!' },
  { title: 'Motorcycles', icon: <TwoWheeler color='primary' sx={{ mb: 2, width: '60px', height: '60px'}}/>, desc: 'Roam around on a motorbike or scooter and explore your travel destinations' },
  { title: 'Bicycles', icon: <PedalBike color='primary' sx={{ mb: 2, width: '60px', height: '60px'}}/>, desc: 'From cycling on the challenging mountains to cycling through beautiful cities' },
  {
    title: 'Insurance', icon: <Assignment color='primary' sx={{ mb: 2, width: '60px', height: '60px'}}/>,
      ...
      <section className='service-main padd-top-60 padd-bottom-60'>
        <div className='container'>
          ...
          <div className='row d-flex justify-content-center mb-4'>
            <div className='col-sm-6 col-lg-3 text-center mb-4 mb-lg-0'>
              <div className='service-grid' data-aos='fade-up'>
                ...
                <h6>Cars</h6>
                <p>
                  A wide range of cars to choose from for your exciting adventures!
                </p>
              </div>
            </div>
            <div className='col-sm-6 col-lg-3 text-center mb-4 mb-lg-0'>
              <div className='service-grid' data-aos='fade-down'>
                ...
                <h6>Motorcycles</h6>
                <p>
                  Roam around on a motorbike or scooter and explore your travel destinations
                </p>
              </div>
            </div>
            <div className='col-sm-6 col-lg-3 text-center mb-4 mb-md-0'>
              <div className='service-grid' data-aos='fade-up'>
                ...
                <h6>Bicycles</h6>
                <p>
                  From cycling on the challenging mountains to cycling through beautiful cities
                </p>
              </div>
            </div>
            <div className='col-sm-6 col-lg-3 text-center'>
              <div className='service-grid' data-aos='fade-down'>
                ...
                <h6>Insurance</h6>
                <p>
                  Variety of covers to choose from for individual hosts, or get covered straight away
                  by
                  commercial hosts
                </p>
              </div>
          ...
          <div className='service-bottom-sec text-center mt-5' data-aos='zoom-in'>
            <h2>
              Easily Fulfil your travel dreams by booking your preferred
              vehicle from trusted hosts
            </h2>
            <p>
              Providing you the freedom of renting a car, motorcycle, or even a bicycle efficiently with
              ease from
              our trusted hosts.
