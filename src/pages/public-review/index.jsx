        ...
        <section className='public-review-main padd-top-60 padd-bottom-60'>
          <div className='container'>
            <div className='company-product-info mb-5' data-aos='fade-up'>
              <div className='public-review-bg position-relative'>
                ...
                <div className='p-image'>
                  ...
                  <input id='cover-image' className='file-upload' type='file' accept='image/*'
              ...
              <div className='p-4 mx-2 mb-2'>
                <div className='row'>
                  <div className='col-md-4 mb-3 mb-md-0'>
                    ...
                    <div
                      className='level-four d-flex justify-content-center justify-content-md-start align-items-center'>
                  ...
                  <div className='col-md-4 mb-3 mb-md-0'>
                    <div className='company-info-center'>
                      <div className='company-review-img mb-3 position-relative'>
                        <img src={profileImage ? profileImage : CompanyReview} alt='company-review-img'
                             className='profile-car' />
                        <div className='p-image'>
                          <label htmlFor='profile-image' className='mb-0 pointer'>
                            <i className='fa fa-camera car-upload-button'/>
                          </label>
                          <input id='profile-image' className='car-file-upload' type='file' accept='image/*'
                  ...
                  <div className='col-md-4 d-flex justify-content-center justify-content-md-end'>
                    <div className='company-info-right pl-5 '>
                      <p><i className='fas fa-check-circle margin-right-five'/> Avg response time 25hrs</p>
                      <p><i className='fas fa-clock margin-right-five'/>99% response rate</p>
                      <p id='share-popover' className='pointer'><i
                        className='fas fa-share-alt margin-right-five pointer'/>Share Profile</p>
                      <Popover placement='bottom' isOpen={openSharePopover} target='share-popover'
                               toggle={toggleSharePopover} className='blog-card-grid blog-card-grid--popover'
                ...
                <div className='company-info'>
                  <p style={{ textAlign: 'justify' }}>I am self employed and mainly work in London as a property
                  ...
                  <div className='company-product-list-grid'>
                    ...
                    <div className='comapany-card-body'>
                      ...
                      <div className='comapany-card-footer d-flex justify-content-between mt-4 pt-2'>
                        <span className='heart-review'><i className='fas fa-heart'/></span>
                        <h2>£100/day(£24/hr)</h2>
                      </div>
                    </div>
                  </div>
            ...
            <div className='car-rating-main' data-aos='fade-up'>
              <h2><i className='fas fa-star mr-2'/>5.0 (31 Reviews)</h2>
