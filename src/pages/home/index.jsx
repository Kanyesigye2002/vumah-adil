      ...
      <section className="service-main padd-top-60 padd-bottom-60">
        <div className="container">
          ...
          <div className="row d-flex justify-content-center mb-4">
            ...
            <div className="col-sm-6 col-lg-3 text-center">
              <div className="service-grid" data-aos="fade-down">
                ...
                <h6>Insurance</h6>
                <p>
                  Variety of covers to choose from for individual hosts, or get covered straight away by
                  commercial hosts
                </p>
              </div>
            </div>
          ...
          <div className="service-bottom-sec text-center mt-5" data-aos="zoom-in">
            ...
            <p>
              Providing you the freedom of renting a car, motorcycle, or even a bicycle efficiently with ease from
              our trusted hosts.
                ...
                <TabPane tabId="4">
                  <div className="customer-support-main">
                    ...
                    <p style={{textAlign: 'justify'}}>
                      ...
                      to enhance the experience of our customers and provide you with the quality you
                      deserve.
                    </p>
                  </div>
                </TabPane>
                ...
                <div className="card-body justify-content-between d-flex flex-column">
                  <div>
                    ...
                    <p style={{textAlign: 'justify'}}>
                      ...
                      From the capital, you can drive 2hrs to reach the beautiful beaches of Brighton, or
                      to
                ...
                <div className="card-body justify-content-between d-flex flex-column">
                  <div>
                    ...
                    <p style={{textAlign: 'justify'}}>
                      ...
                      physical health. Not only does travelling provide the opportunity to experience the
                      beauty of nature, different architectures and people, but it allows us to explore
                      new
