      ...
      <div className="container">
          ...
          <div className="p-4 mx-2 mb-2">
            ...
            <div className="company-info">
              <p style={{ textAlign: 'justify' }}>
                I am self employed and mainly work in London as a property management consultant. I fell in love with
                The Old School House while I was studying Zen Meditation in the Lake District The house is now my second
                home and provides a peaceful rural retreat. Set in the UNESCO world heritage National Park it’s lovely
                to be able to share such a unique place with you.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="car-rating-main" data-aos="fade-up">
          ...
          <div className="car-people-rating">
            ...
            <p>Great Car, and great hosts! Stephen was very accommodating and very flexible. Would 10/10 rent again!</p>
          </div>
        </div>
      </div>
    </section>
