                ...
                <div className='col-md-5'>
                  <div className='account-grid' data-aos='fade-up'>
                    <div className='account-profile-box mb-4'>
                      ...
                      <div className='p-image account-profile-icon'>
                        <label htmlFor='plus-up' className='m-0 pointer'><i className='fas fa-plus' /></label>
                        <input id='plus-up' onChange={handleUpload} className='file-upload' type='file'
                               accept='image/*' />
                      </div>
                    </div>
                    ...
                    <div
                      ...
                      <button className='common-btn' onClick={() => onOpen('Update Password',<><UpdatePasswordModal /></>)}>
                        Update
                      </button>
                    </div>
                    <div
                      ...
                      <button className='common-btn' onClick={() => onOpen('Update Phone Number',<UpdatePhoneNumberModal />)}>
                        Update
                      </button>
                    </div>
                  </div>
                  ...
                  <div className='account-grid border-0' data-aos='fade-up'>
                    <div className='account-update-field'>
                      <button className='common-btn' onClick={handleClickOpen}>Deactivate my account</button>
                    </div>
                  </div>
                </div>
                <div className='col-md-1'/>
                {user.isBusiness && <StaffTable />}
                {/*<StaffTable />*/}
              </div>
            </div>
          </section>
