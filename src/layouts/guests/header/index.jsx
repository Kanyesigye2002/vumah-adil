                                            ...
                                            <DropdownMenu className="dropdown-menu">
                                                ...
                                                <DropdownItem style={{display: 'flex'}}>
                                                    <Link to="/public-review"
                                                          style={{color: 'inherit', width: '100%'}}>Profile</Link>
                                                </DropdownItem>
                                                <DropdownItem style={{display: 'flex'}}><Link to="/account" style={{
                                                    color: 'inherit',
                                                    width: '100%'
                                                }}>Notifications</Link></DropdownItem>
                                                <DropdownItem style={{display: 'flex'}}><Link to="/messages" style={{
                                                    color: 'inherit',
                                                    width: '100%'
                                                }}>Messages</Link></DropdownItem>
                                                <DropdownItem style={{display: 'flex'}}><Link to="/chat" style={{
                                                    color: 'inherit',
                                                    width: '100%'
                                                }}>Bookings</Link></DropdownItem>
                                                <DropdownItem style={{display: 'flex'}}><Link to="/account" style={{
                                                    color: 'inherit',
                                                    width: '100%'
                                                }}>Favourites</Link></DropdownItem>
                                                <DropdownItem divider/>

                                                <DropdownItem style={{display: 'flex'}}><Link to="/earning" style={{
                                                    color: 'inherit',
                                                    width: '100%'
                                                }}>Vehicle Listings</Link></DropdownItem>
